...
I have added below how you can deploy the same project in using lambda and attaching an API endpoint to it. You can follow the steps below on how to setup the code using 
...
** Step 1: Zip up the following files below in the Project repo **
